                ...
                <li>
                    ...
                    <div>
                        ...
                        <ul>
                            ...
                            <li class="item_lista-servicos">Emissão, controle e acompanhamento de certidões negativas junto aos órgãos públicos e instituições privadas.</li>
                            <li class="item_lista-servicos">Registros perante Junta Comercial do Estado de São Paulo (JUCESP), Receita Federal, Prefeituras Municipais, Secretaria da Fazenda do Estado de São Paulo, INSS e Caixa Econômica Federal.</li>
                            <li class="item_lista-servicos">Cadastros federais, estaduais e municipais com o acompanhamento de vencimentos de certidões.</li>
                        </ul>
                    </div>
                </li>
            </ul>
